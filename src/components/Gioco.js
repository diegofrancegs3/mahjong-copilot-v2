...
import GraficoPartita from "./GraficoPartita"; // Importazione del nuovo componente
...
export default function Gioco({ datiPartita, currentPartitaId, mioNome }) {
  ...
  const mioVento = mappaVenti[mioNome] || "Sconosciuto";
        ...
        <>
          {!datiPartita.fase_calcolo ? (
            <div style={cardStile}>
              ...
              >
                <div>
                  <p style={{ fontSize: "0.75rem", opacity: 0.8 }}>DADI</p>
                  <div style={{ fontSize: "2rem", fontWeight: "bold" }}>
                    {dadi.lancio1 ? dadi.lancio1 + dadi.lancio2 : "--"}
                  </div>
                </div>
                <div>
                  <p style={{ fontSize: "0.75rem", opacity: 0.8 }}>MURO</p>
                  <div
                    style={{
                      fontSize: "2rem",
                      fontWeight: "bold",
          ...
          ) : datiPartita.fase_calcolo === "gioco_attivo" ? (
            <div
              style={{
                marginTop: "80px",
                display: "flex",
          ...
          ) : datiPartita.fase_calcolo === "inserimento" ? (
            <div style={cardStile}>
              {mostraSelettore && (
                <div style={modalOverlay}>
                  <div style={modalContent}>
                    <CalcolatoreStecca
                      isEst={isEst}
                      mioVento={mioVento}
                      chiHaChiuso={datiPartita.vincitore_mahjong === mioNome}
              ...
              <h3 style={{ color: "#fbbf24", marginBottom: "20px" }}>
                {datiPartita.vincitore_mahjong === mioNome
                  ? "HAI FATTO MAHJONG!"
                  : `${datiPartita.vincitore_mahjong} ha fatto Mahjong!`}
              </h3>
              {!(datiPartita.punti_dichiarati?.[mioNome] !== undefined) ? (
                <div
                  style={{
                    maxWidth: "280px",
                    margin: "0 auto",
